...
## Chapter 1 -  getting into software design patterns examples
 1. **OOP** pilars **APIE** :
    ...
    - polymorphism  (P)
        - method overloading
            - [Figure 1.5 - `Vehicle` class](./Capther01/apie/Vehicle.java)
        - method overriding
            - [Example 1.2, Figure 1.6 - `Vehicle` class](./Capther01/apie/Vehicle.java)
            - [Example 1.2, Figure 1.6 - `Car` class](./Capther01/apie/Car.java)
    - abstraciton   (A)
        - abstract `class`
            - [Example 1.3, Figure 1.7 - `AbstractVehicle` class](./Capther01/apie/AbstractVehicle.java)
            - [Example 1.3, Figure 1.7 - `CommonCar` class](./Capther01/apie/CommonCar.java)
            - [Example 1.3, Figure 1.7 - `SportCar` class](./Capther01/apie/SportCar.java)
        - interface `class`
            - [Example 1.4, Figure 1.8 - `VehicleInterface` class](./Capther01/apie/VehicleInterface.java)
            - [Example 1.4, Figure 1.8 - `Truck` class](./Capther01/apie/Truck.java)
            - [Example 1.4, Figure 1.8 - `Bus` class](./Capther01/apie/Bus.java) 
        - abstract and interface `classes`
            - [Figure 1.9 - `VehicleInterface` class](./Capther01/apie/VehicleInterface.java)
            - [Figure 1.9 - `AbstractVehicle` class](./Capther01/apie/AbstractVehicle.java)
            - [Figure 1.9 - `Truck` class](./Capther01/apie/CommonCar.java)
            - [Figure 1.9 - `Bus` class](./Capther01/apie/SportCar.java) 


 2. SOLID Principles
    - single-responsiblity principle (SRP)
        - [Figure 1.12 - `Vehicle` class](./Chapter01/solid/srp/Vehicle.java)
        - [Figure 1.12 - `Engine` class](./Chapter01/solid/srp/Engine.java)
        - [Figure 1.12 - `VehicleComputer` class](./Chapter01/solid/srp/VehicleComputer.java)
    - open-closed principle (OCP)
        - [Example 1.5 - `Vehicle` class](./Chapter01/solid/general/Vehicle.java)
        - [Example 1.5 - `Truck` class](./Chapter01/solid/general/Truck.java)
        - [Example 1.6 - `Example1_6Main` class](./Chapter01/solid/general/Example1_6Main.java)
    - liskov substitution principle (LSP)
        - [Example 1.7 - `Vehicle` class](./Chapter01/solid/general/Vehicle.java)
        - [Example 1.7 - `CarWash` class](./Chapter01/solid/general/CarWash.java)
        - [Example 1.7 - `Car` class](./Chapter01/solid/general/Car.java)
        - [Example 1.7 - `SportCar` class](./Chapter01/solid/general/SportCar.java)
        - [Example 1.7 - `Example1_7Main.java` class](./Chapter01/solid/general/Example1_7Main.java)
    - interface segregation principle (ISP)
        - malicious
            - [Example 1.8 - `Vehicle` class](./Chapter01/solid/spi_malicious/Vehicle.java)
            - [Example 1.8 - `Bike` class](./Chapter01/solid/spi_malicious/Bike.java)
            - [Example 1.8 - `Car` class](./Chapter01/solid/spi_malicious/Car.java)
            - [Example 1.8 - `Example1_8Main` class](./Chapter01/solid/spi_malicious/Example1_8Main.java)
        - optimal
            - [Example 1.9 - `Vehicle` class](./Chapter01/solid/spi_optimal/Vehicle.java)
            - [Example 1.9 - `Bike` class](./Chapter01/solid/spi_optimal/Bike.java)
            - [Example 1.9 - `Car` class](./Chapter01/solid/spi_optimal/Car.java)
            - [Example 1.9 - `HasEngine` class](./Chapter01/solid/spi_optimal/HasEngine.java)
            - [Example 1.9 - `HasPedals` class](./Chapter01/solid/spi_optimal/HasPedals.java)
            - [Example 1.9 - `Example1_8Main` class](./Chapter01/solid/spi_optimal/Example1_9Main.java)
    - dependency inversion principle (DIP)
        - [Example 1.10 - `Gerage` class](./Chapter01/solid/dip/Garage.java)
